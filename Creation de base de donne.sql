...
insert into medecin values('ee3333','boutissante','issam','0610811157',1)
insert into medecin values('ee3333','Mazzouz','chaimae','0610811157',1)
...
duree float,
prix money
constraint pk_ligneMedecinOperation primary key(idMedecin,idOperation),
